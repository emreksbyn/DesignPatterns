...
namespace ChainOfResponsibility
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Expense expense1 = new Expense { Detail = "Training", Amount = 10 };
            manager.HandleExpense(expense1);

            Expense expense2 = new Expense { Detail = "Training", Amount = 110 };
            manager.HandleExpense(expense2);

            Expense expense3 = new Expense { Detail = "Training", Amount = 1100 };
